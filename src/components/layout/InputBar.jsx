 ...
 * InputBar Component
 * 
 * A standalone input bar that is always visible at the bottom of the screen
 * and is shared across all features.
 */
const InputBar = ({
  inputMessage,
  setInputMessage,
  ...
  return (
    <div className={`fixed bottom-0 left-0 ${sidebarCollapsed ? 'lg:left-16' : 'lg:left-80'} right-0 bg-neuro-base border-t border-neuro-200 z-40`}>
      <motion.div 
