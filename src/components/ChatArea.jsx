        ...
        <form onSubmit={handleSubmit} className="flex gap-2">
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full p-3 pr-12 border border-neuro-300 rounded-lg focus:ring-2 focus:ring-neuro-500 focus:border-transparent resize-none min-h-[50px] max-h-32"
              rows={1}
